...
export class App {
  ...
  private async _connectToDataBase() {
    ...
    const question2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '2.	В каком приказе при продаже «Стэдис» необходимо учитывать соответствие кода вида МИ?',
      questionNumber: 2,
      quiz: quiz,
    }
    ...
    const question3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '3.	Сколько сенсоров «Нейросенс» включает стандартный комплект для анализа всех параметров ходьбы, в том числе анализа работы всех суставов нижних конечностей?',
      questionNumber: 3,
      quiz: quiz,
    }
    ...
    const question4 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '4.	Что не является преимуществом системы для стабилографии «Стэдис-Баланс» по сравнению со стабилоплатформами?',
      questionNumber: 4,
      quiz: quiz,
    }
    ...
    const question6 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '6. Какое оборудование в составе комплекса «НС-Психотест» позволяет объективно оценить силу и выносливость?',
      questionNumber: 6,
      quiz: quiz,
    }
    ...
    const question7 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        'Какие специалисты НЕ могут работать с комплексом НС-Психотест?',
      questionNumber: 7,
      quiz: quiz,
    }
    ...
    const question8 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '8. С какими возрастными категориями возможно проводить диагностические исследования с использованием комплекса «НС-Психотест»?',
      questionNumber: 8,
      quiz: quiz,
    }
    ...
    const question10 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '10. Основным преимуществом программы «Нейро-МС.NET» НЕ является',
      questionNumber: 10,
      quiz: quiz,
    }
    ...
    const question11 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '11. Какие виды стимуляции можно проводить с использованием прибора «Нейростим»?',
      questionNumber: 11,
      quiz: quiz,
    }
    ...
    const question12 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '12. Системы каких производителей, поставляемых на рынок РФ, могут использоваться для проведения магнитной стимуляции с нейронавигацией в рамках оказания высокотехнологичной медицинской помощи (ВМП)? ',
      questionNumber: 12,
      quiz: quiz,
    }
    ...
    const question14 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '14. Какой параметр регулируется в безопасном режиме в системе «Мультитренер»?',
      questionNumber: 14,
      quiz: quiz,
    }
    ...
    const question15 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '15. С помощью какого оборудования можно провести тест 6-минутной ходьбы?',
      questionNumber: 15,
      quiz: quiz,
    }
    ...
    const question16 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '16. По какому приказу продается «Мультитренер»?',
      questionNumber: 16,
      quiz: quiz,
    }
    ...
    const question18 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '18. Где используются ЭЭГ аппараты в ветеринарной практике?',
      questionNumber: 18,
      quiz: quiz,
    }
    ...
    const question19 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '19. Где чаще всего используется электроретинограф?',
      questionNumber: 19,
      quiz: quiz,
    }
    ...
    const question3_q2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '3. Выберите одно преимущество, которое НЕ может быть указано при демонстрации пользователю системы для интраоперационного мониторинга «Нейро-ИОМ»',
      questionNumber: 3,
      quiz: quiz2,
    }
    ...
    const question5_q2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '5. Какой функциональной пробы НЕТ в списке общепринятых проб, проводимых при рутинном ЭЭГ-обследовании?',
      questionNumber: 5,
      quiz: quiz2,
    }
    ...
    const question6_q2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '6. Врач какой специальности занимается расшифровкой результатов ЭЭГ-обследований?',
      questionNumber: 6,
      quiz: quiz2,
    }
    ...
    const question7_q2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '7. Какой прибор ЭЭГ предлагать в госЛПУ если закупка будет по КТРУ?',
      questionNumber: 7,
      quiz: quiz2,
    }
    ...
    const question11_q2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '11. Основное преимущество для потенциальных пользователей при покупке Амнис:',
      questionNumber: 11,
      quiz: quiz2,
    }
    ...
    const question13_q2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '13. Выберите параметры, которые регистрирует Снорлекс:',
      questionNumber: 13,
      quiz: quiz2,
    }
    ...
    const question14_q2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '14. Респираторный полиграф Снорлекс по классификации РОС соответствует типам приборов',
      questionNumber: 14,
      quiz: quiz2,
    }
    ...
    const question15_q2 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '15. Выберите утверждение, которое НЕ может быть причиной, почему выгодно продавать полисомнографы «Нейрософт»',
      questionNumber: 15,
      quiz: quiz2,
    }
    ...
    const question2_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '2. «Эргопойнт» - система для нагрузочного тестирования может поставляться к имеющемуся у больницы нагрузочному устройству?',
      questionNumber: 2,
      quiz: quiz3,
    }
    ...
    const question3_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '3. Какое оборудование НЕ может быть использовано для кардиоинтервалографии? ',
      questionNumber: 3,
      quiz: quiz3,
    }
    ...
    const question4_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '4. Какое оборудование нужно для оценки эластических свойств сосудов?',
      questionNumber: 4,
      quiz: quiz3,
    }
    ...
    const question6_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '6. Вызванных потенциалов какой модальности не существует?',
      questionNumber: 6,
      quiz: quiz3,
    }
    ...
    const question8_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '8. С каким миографом можно использовать ТМС?',
      questionNumber: 8,
      quiz: quiz3,
    }
    ...
    const question10_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        'Какой импенадсометрической методики нет в приборе «Аудио-СМАРТ»?',
      questionNumber: 10,
      quiz: quiz3,
    }
    ...
    const question11_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '11. В каком отделе органа слуха волосковые клетки преобразуют колебания в электрические нервные импульсы?',
      questionNumber: 11,
      quiz: quiz3,
    }
    ...
    const question12_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '12. Какие аудиологические приборы можно предлагать к продаже в отделения для больных с ОНМК (острыми нарушениями мозгового кровообращения)?',
      questionNumber: 12,
      quiz: quiz3,
    }
    ...
    const question15_q3 = {
      questionStatus: 'unread' as QuestionStatusTypes,
      question:
        '15. Что из ниже перечисленного НЕ явялется преимуществом спирометра «Спиро-Спектр»?',
      questionNumber: 15,
      quiz: quiz3,
    }
